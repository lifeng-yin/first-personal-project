...
const Signup = () => {
  ...
  const handlePasswordSignup = async () => {
    ...
    if (password !== confirmPassword) {
      setErrorMessage(prevMsg => prevMsg + 'Passwords do not match.')
    }
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center">
        <Card className="px-10 py-8">
          <CardHeader>
            <h1 className="text-[2.2rem] font-semibold text-center">Create an account</h1>
          </CardHeader>
          <CardContent>
            <Button
              variant="outline"
            ...
            <Input
              ...
              className="outline-none focus:outline-black mb-4"
            />
            <Label htmlFor="confirm-password" className="text-lg mb-4">Confirm Password</Label>
            <Input
